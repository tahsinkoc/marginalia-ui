  ...
  return (
    <>
      <SectionIntro
        ...
        description="Browse the component index from the left rail, jump to a section, then compare the starter code with its rendered output without leaving the page."
      />
